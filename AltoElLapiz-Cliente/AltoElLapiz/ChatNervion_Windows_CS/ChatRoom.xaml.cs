...
namespace ChatNervion
{
    ...
    public sealed partial class ChatRoom : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            this.tblGroupName.Text = "prueba";
            this.tblUserName.Text = "prueba los micrófono";
        ...
        private async void btnExit_Click(object sender, RoutedEventArgs e)
        {
            ...
            Frame.Navigate(typeof(MainPage), new { groupName = group.nombreGrupo, userName = group.Nick });
        }
